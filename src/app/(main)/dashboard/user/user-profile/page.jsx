...
export default async function UserDashboardOverview() {
    ...
    const bmiNumber = Number(userData?.bmi);

    const bmiStatus = !userData?.bmi
        ? 'Not Set'
        : bmiNumber < 18.5
            ? 'Underweight'
            : bmiNumber < 25
    ...
    const summaryCards = [
        {
            icon: <MdCalculate />,
            title: 'BMI Score',
            value: userData?.bmi || 'Not Set',
            subText: bmiStatus,
        },
        {
            icon: <MdTrackChanges />,
            title: 'Fitness Goal',
            value: goalLabels[userData?.fitnessGoal] || 'Not Set',
            subText: "You're on the right track!",
        },
        {
            icon: <MdDirectionsRun />,
            title: 'Activity Level',
            value: activityLabels[userData?.activityLevel] || 'Not Set',
